function selectLanguage() {
    ...
    if (language === 'eng' || language === 'hindi') {      //printing message --Form a sentence (Declarative or Interrogative or any other type) from the given words
    ...
    if (language === 'eng') {//all multiple correct english sentences with 10 different questions
    ...
    else if (language === 'hindi') {        //all multiple correct hindi sentences with 7 different sentences
